    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: '#FFFFFF', padding: 16 }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginVertical: 20 }}>
                <TouchableOpacity style={{ paddingVertical: 10, paddingHorizontal: 60, backgroundColor: '#E0E0E0', borderRadius: 20 }} onPress={discardFilters}>
                    <Text style={{ fontSize: 16, fontWeight: 'bold', color: '#000000' }}>Discard</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{ paddingVertical: 10, paddingHorizontal: 60, backgroundColor: '#FF3B30', borderRadius: 20 }} onPress={applyFilters}>
