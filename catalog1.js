...
const katalog1 = () => {
  ...
  const [products, setProducts] = useState([
    {
      name: 'Casual T-shirt',
      image: require('./assets/produk4.jpeg'),
      color: 'Brown',
      size: 'M',
      price: 25,
      rating: 4,
    ...
    {
      name: 'T-shirt',
      image: require('./assets/produk5.jpeg'),
      color: 'Black',
      size: 'L',
      price: 80,
      rating: 5,
    ...
    {
      name: 'Party Dress',
      image: require('./assets/produk6.jpeg'),
      color: 'Green',
      size: 'L',
      price: 21,
      rating: 3,
    ...
    <View style={{ flex: 1, backgroundColor: '#fff', padding: 12 }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
        ...
        <TouchableOpacity style={{ paddingLeft: 8 }}>
          <Image source={require('./assets/searchred.png')} style={{ width: 20, height: 20, tintColor: '#333333' }} />
        </TouchableOpacity>
      </View>
